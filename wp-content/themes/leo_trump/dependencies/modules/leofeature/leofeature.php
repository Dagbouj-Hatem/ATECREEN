...
class Leofeature extends Module
{
    ...
    public function __construct()
    {
        ...
        Configuration::updateValue('LEOFEATURE_TYPE_DROPDOWN_DEFAULTCART', 'dropdown');
        Configuration::updateValue('LEOFEATURE_SHOW_POPUP', '1');
        Configuration::updateValue('LEOFEATURE_NUMBER_CARTITEM_DISPLAY_ALLCART', '3');
    }
    ...
    public function hookHeader()
    {
        ...
        if (!Configuration::isCatalogMode()) {
            if (Configuration::get('LEOFEATURE_ENABLE_AJAXCART') || Configuration::get('LEOFEATURE_ENABLE_DROPDOWN_DEFAULTCART')) {
            ...
            if ((Configuration::get('LEOFEATURE_ENABLE_DROPDOWN_DEFAULTCART')) && $page_name != 'order') {
...
//            }
    ...
    {
        if (!Configuration::isCatalogMode()) {
            if ((Configuration::get('LEOFEATURE_ENABLE_AJAXCART') && Configuration::get('LEOFEATURE_ENABLE_NOTIFICATION')) || Configuration::get('LEOFEATURE_ENABLE_DROPDOWN_DEFAULTCART')) {
                $vertical_position = '';
    ...
    {
        return '<div class="alert alert-warning ap-free-warning"><marquee direction="right" behavior="alternate">You are using free version of Leofeature. '
