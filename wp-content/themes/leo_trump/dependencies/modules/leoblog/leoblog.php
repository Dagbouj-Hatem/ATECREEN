...
//            $id_tab1 = $tab1->add(true, false);
    ...
    public function getContent()
    {
        ...
        return LeoBlogHelper::freeText().$this->_html.$this->renderForm();
    }
    ...
    public function hookDisplayHeader()
    {
        ...
        if (file_exists(_PS_THEME_DIR_.'css/modules/leoblog/assets/leoblog.css')) {
            $this->context->controller->addCSS(__PS_BASE_URI__.$media_dir.'assets/leoblog.css', 'all');
        } else {
            $this->context->controller->addCSS(__PS_BASE_URI__.$media_dir.'css/leoblog.css', 'all');
        }
