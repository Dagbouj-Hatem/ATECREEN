...
class AdminLeoblogDashboardController extends ModuleAdminController
{
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('saveConfiguration')) {
            ...
            // print_r(Tools::getValue('LEOBLOG_DASHBOARD_DEFAULTTAB'));
            
            Configuration::updateValue('LEOBLOG_DASHBOARD_DEFAULTTAB', Tools::getValue('LEOBLOG_DASHBOARD_DEFAULTTAB'));
            // print_r(Configuration::updateValue('LEOBLOG_DASHBOARD_DEFAULTTAB'));
            // die();
        }
    }
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'disabled' => 'disabled',
                    'desc' => LeoBlogHelper::freeTextDes(),
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Root'),
...
//                ),
        ...
        $template->assign(array(
            ...
            'freeWarning' => LeoBlogHelper::freeTextWhensubmit(),
        ));
        // print_r(Configuration::get('LEOBLOG_DASHBOARD_DEFAULTTAB'));die();
        return LeoBlogHelper::freeText().$template->fetch();
    }
